...
## Installation:
**Download and run Installer.exe from Releases(todo: add clickable link under the Releases button). Or download auto-launcher.dll with game executable and manually dragndrop it to your \bin\win64 with replacement**
