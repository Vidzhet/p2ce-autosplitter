...
void IMGUI_SETSTYLE()
{
    ...
    style.Colors[ImGuiCol_CloseButton] = ImVec4(0, 0, 0, 0);
    style.Colors[ImGuiCol_CloseButtonHovered] = ImVec4(0, 0, 0, 0);
    style.Colors[ImGuiCol_CloseButtonActive] = ImVec4(0, 0, 0, 0);
    ...
    style.Colors[ImGuiCol_ScrollbarGrab] = ImVec4(0.2f, 0.2f, 0.2f, 1.0f);
    style.Colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.3f, 0.3f, 0.3f, 1.0f);
    style.Colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.7f, 0.4f, 0, 1);
    ...
    bold_fontX16 = io.Fonts->AddFontFromFileTTF("C:\\Windows\\Fonts\\Calibrib.ttf", 16.0f);
